<%@ Page Language="C#" MasterPageFile="~/APP/master pages/principal.Master" AutoEventWireup="true"
    CodeBehind="Asignacion Transformador.aspx.cs" Inherits="TS15V2.UI.APP.Gestion_Transformador.Asignacion_Transformador"
    ...
    <div class="row-fluid sortable ui-sortable">
        <div class="box span12">
            <div data-original-title="" class="box-header">
                <h2>
                    <i class="halflings-icon edit"></i><span class="break"></span>Asignar Transformadores</h2>
                <div class="box-icon">
