<%@ Page Language="C#" MasterPageFile="~/APP/master pages/principal.Master" AutoEventWireup="true"
    CodeBehind="Asignar Transformador.aspx.cs" Inherits="TS15V2.UI.APP.Gestion_Transformador.Asignar_Transformador" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphPrincipal" runat="server">
    <ul class="breadcrumb">
        ...
        <li><i class="icon-edit"></i><a href="#">Asignar Transformador</a> </li>
    </ul>
        ...
        <div class="box span12">
            ...
            <div class="box-content">
                <div class="row-fluid">
                    ...
                    <div class="span3">
                        <br />
                        <asp:Button runat="server" ID="btRetirar" Text="Retirar Transformador" CssClass="btn btn-success"
